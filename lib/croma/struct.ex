defmodule Croma.Struct do
  ...
  - This module, `Croma.Struct` itself for nested structs.
      - `:recursive_new?` option may come in handy. See the section below.
  ...
  When you want to define and validate nested data structure with `Croma.Struct`,
  it's convenient to recursively calling `new/1` for each Croma-generated nested structs,
  so that whole data structure can be generated by just one invocation of `new/1` of root struct.
